...
#define CAN_UNPACK_STEERING_OUTPUT(msg_ptr, cruise_control_u16, control_stalk_analog_state_u16, control_stalk_digital_state_u16) \
  can_unpack_impl_u16((msg_ptr), 2, (cruise_control_u16), (control_stalk_analog_state_u16),                                             \
