...
#define CAN_PACK_POWER_STATE(msg_ptr, power_state_u8)                                        \
  can_pack_impl_u8((msg_ptr), SYSTEM_CAN_DEVICE_DRIVER_CONTROLS_CENTER_CONSOLE,              \
...
#define CAN_PACK_MOTOR_CONTROLLER_RESET(msg_ptr, motor_controller_u8)                   \
  can_pack_impl_u8((msg_ptr), SYSTEM_CAN_DEVICE_DRIVER_CONTROLS_CENTER_CONSOLE,         \
                   SYSTEM_CAN_MESSAGE_MOTOR_CONTROLLER_RESET, 1, (motor_controller_u8), \
                   CAN_PACK_IMPL_EMPTY, CAN_PACK_IMPL_EMPTY, CAN_PACK_IMPL_EMPTY,       \
                   CAN_PACK_IMPL_EMPTY, CAN_PACK_IMPL_EMPTY, CAN_PACK_IMPL_EMPTY,       \
                   CAN_PACK_IMPL_EMPTY)
...
#define CAN_PACK_HORN(msg_ptr, state_u8)                                          \
  can_pack_impl_u8((msg_ptr), SYSTEM_CAN_DEVICE_DRIVER_CONTROLS_CENTER_CONSOLE,   \
                   SYSTEM_CAN_MESSAGE_HORN, 1, (state_u8), CAN_PACK_IMPL_EMPTY,   \
                   CAN_PACK_IMPL_EMPTY, CAN_PACK_IMPL_EMPTY, CAN_PACK_IMPL_EMPTY, \
                   CAN_PACK_IMPL_EMPTY, CAN_PACK_IMPL_EMPTY, CAN_PACK_IMPL_EMPTY)
...
#define CAN_PACK_STEERING_OUTPUT(msg_ptr, event_id_u16, data_u16)                      \
  can_pack_impl_u16((msg_ptr), SYSTEM_CAN_DEVICE_DRIVER_CONTROLS_STEERING,             \
                    SYSTEM_CAN_MESSAGE_STEERING_OUTPUT, 4, (event_id_u16), (data_u16), \
                    CAN_PACK_IMPL_EMPTY, CAN_PACK_IMPL_EMPTY)
...
#define CAN_PACK_PEDAL_OUTPUT(msg_ptr, throttle_u16, throttle_state_u16, mech_brake_u16)      \
  can_pack_impl_u16((msg_ptr), SYSTEM_CAN_DEVICE_DRIVER_CONTROLS_PEDAL,                       \
                    ...
                    (mech_brake_u16), CAN_PACK_IMPL_EMPTY)
