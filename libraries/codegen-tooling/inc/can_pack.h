...
#define CAN_PACK_STEERING_OUTPUT(msg_ptr, cruise_control_u16, control_stalk_analog_state_u16, control_stalk_digital_state_u16) \
  can_pack_impl_u16((msg_ptr), SYSTEM_CAN_DEVICE_STEERING_CONTROLS,                                                            \
                    SYSTEM_CAN_MESSAGE_STEERING_OUTPUT, 2, (cruise_control_u16), (control_stalk_analog_state_u16),               \
                    (control_stalk_digital_state_u16), CAN_PACK_IMPL_EMPTY)
