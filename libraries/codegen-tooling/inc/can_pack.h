...
#define CAN_PACK_PEDAL_OUTPUT(msg_ptr, throttle_u16, throttle_state_u16, mech_brake_state_u16) \
...
can_pack_impl_u8((msg_ptr), SYSTEM_CAN_DEVICE_STEERING_CONTROLS, SYSTEM_CAN_MESSAGE_CRUISE_TARGET, 1, \
