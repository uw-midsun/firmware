...
typedef enum {
  ...
  SYSTEM_CAN_DEVICE_CHAOS = 2,
  SYSTEM_CAN_DEVICE_TELEMETRY = 3,
  SYSTEM_CAN_DEVICE_LIGHTS_FRONT = 4,
  SYSTEM_CAN_DEVICE_LIGHTS_REAR = 5,
  SYSTEM_CAN_DEVICE_MOTOR_CONTROLLER = 6,
  SYSTEM_CAN_DEVICE_DRIVER_CONTROLS = 7,
  SYSTEM_CAN_DEVICE_DRIVER_DISPLAY = 8,
  SYSTEM_CAN_DEVICE_SOLAR_MASTER_FRONT = 9,
  SYSTEM_CAN_DEVICE_SOLAR_MASTER_REAR = 10,
  SYSTEM_CAN_DEVICE_SENSOR_BOARD = 11,
  SYSTEM_CAN_DEVICE_CHARGER = 12,
