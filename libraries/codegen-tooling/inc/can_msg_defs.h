...
typedef enum {
  ...
  SYSTEM_CAN_MESSAGE_CHARGER_CONN_STATE = 26,  // isn't this reserved for mech brake?
  ...
  SYSTEM_CAN_MESSAGE_STEERING_OUTPUT = 48,
  SYSTEM_CAN_MESSAGE_PEDAL_OUTPUT = 49,  // this is an used DC range but this is not ideal
