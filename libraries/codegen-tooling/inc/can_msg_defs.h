...
typedef enum {
  ...
  SYSTEM_CAN_MESSAGE_GPS_TIME_AND_ALTITUDE = 53,
  SYSTEM_CAN_MESSAGE_GPS_LONGITUDE_AND_SATTELITES_USED = 54,
  SYSTEM_CAN_MESSAGE_GPS_LATITUDE_AND_POS_FIX_INDICATOR = 55,
  SYSTEM_CAN_MESSAGE_GPS_SPEED_AND_HDOP = 56,
