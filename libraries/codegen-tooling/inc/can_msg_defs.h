...
typedef enum {
  ...
  SYSTEM_CAN_MESSAGE_SET_MODULE_DISCHARGE = 21,
  ...
  SYSTEM_CAN_MESSAGE_GPS_UTC_TIME = 53,
  SYSTEM_CAN_MESSAGE_GPS_LONGITUDE_AND_SATELITES_USED = 54,
  SYSTEM_CAN_MESSAGE_GPS_LATITUDE_AND_POSITION_FIX_INDICATOR = 55,
  SYSTEM_CAN_MESSAGE_GPS_SPEED_AND_TRUE_HEADING = 56,
