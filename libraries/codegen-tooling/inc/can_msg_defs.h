...
typedef enum {
  ...
  SYSTEM_CAN_DEVICE_CONSOLE_CONTROLS = 8,
  ...
  SYSTEM_CAN_DEVICE_STEERING_CONTROLS = 14,
  SYSTEM_CAN_DEVICE_PEDAL_CONTROLS = 15,
  NUM_SYSTEM_CAN_DEVICES = 16
} SystemCanDevice;
...
typedef enum {
  ...
  SYSTEM_CAN_MESSAGE_CONSOLE_OUTPUT = 18,
  ...
  SYSTEM_CAN_MESSAGE_CHARGER_CONN_STATE = 26,  // ELEC-580: isn't this reserved for mech brake?
  ...
  SYSTEM_CAN_MESSAGE_STEERING_OUTPUT = 48, // ELEC-580: this is an used DC range but this is not ideal
  SYSTEM_CAN_MESSAGE_PEDAL_OUTPUT = 49,
