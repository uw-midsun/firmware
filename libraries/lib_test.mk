...
UNITY_GEN_RUNNER := ruby $(UNITY_SCRIPT_DIR)/generate_test_runner.rb
...
$(LIB)_TEST_RUNNERS := $($(LIB)_TEST:$($(LIB)_TEST_ROOT)/%.c=$($(LIB)_GEN_DIR)/%_runner.c)
...
$($(LIB)_TESTS): $($(LIB)_TEST_BIN_DIR)/%$(PLATFORM_EXT): $($(LIB)_TEST_OBJ_DIR)/%.o $($(LIB)_TEST_OBJ) $(call dep_to_lib,$($(LIB)_TEST_DEPS)) | $($(LIB)_TEST_BIN_DIR)
