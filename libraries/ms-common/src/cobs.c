...
//
// Essentially, the goal is to break up the data into groups of either 254 non-zero bytes or 0-253
// non-zero bytes followed by a zero byte. We append a zero byte to the data first so this is always
// possible.
//
