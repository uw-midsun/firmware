...
// before running and the
// callback is the process to run once the time has expired. The timer_id is set
// to the id of the
...
// in use. Note that since timer ids are re-used this could return false values
// once the timer has
