...
// by declaring it
// as a function. We use macros to hide that function, proving an interface to
// declare simple
...
// This keeps track of states and signals that a transition has occurred through
// the pointer.
