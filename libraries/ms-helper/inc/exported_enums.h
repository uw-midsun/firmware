...
typedef enum {
  EE_CENTER_CONSOLE_DIGITAL_INPUT_LOW_BEAM = 0u,
...
typedef enum {
  EE_STEERING_DIGITAL_INPUT_HORN_PRESSED = 0u,
  EE_STEERING_DIGITAL_INPUT_HORN_RELEASED,
  EE_STEERING_DIGITAL_INPUT_CC_ON_OFF_PRESSED,
  EE_STEERING_DIGITAL_INPUT_CC_ON_OFF_RELEASED,
  EE_STEERING_DIGITAL_INPUT_CC_SET_PRESSED,
  EE_STEERING_DIGITAL_INPUT_CC_SET_RELEASED,
  NUM_EE_STEERING_DIGITAL_INPUTS,
} EESteeringDigitalInputs;

typedef enum {
  EE_STEERING_ANALOG_INPUT_DUMMY = 0,
  EE_STEERING_ANALOG_INPUT_CC_SPEED_NEUTRAL,
  EE_STEERING_ANALOG_INPUT_CC_SPEED_PLUS,
  EE_STEERING_ANALOG_INPUT_CC_SPEED_MINUS,
  EE_STEERING_ANALOG_INPUT_CC_CANCEL_RESUME_NEUTRAL,
  EE_STEERING_ANALOG_INPUT_CC_CANCEL_RESUME_CANCEL,
  EE_STEERING_ANALOG_INPUT_CC_CANCEL_RESUME_RESUME,
  EE_STEERING_ANALOG_INPUT_TURN_SIGNAL_STALK_NONE,
  EE_STEERING_ANALOG_INPUT_TURN_SIGNAL_STALK_LEFT,
  EE_STEERING_ANALOG_INPUT_TURN_SIGNAL_STALK_RIGHT,
  NUM_EE_STEERING_ANALOG_INPUTS,

  // Unused
  // EE_STEERING_ANALOG_INPUT_CC_DISTANCE,
} EESteeringAnalogInput;
