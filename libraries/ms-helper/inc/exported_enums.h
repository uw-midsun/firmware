...
typedef enum {
  EE_CONTROL_STALK_ANALOG_DISTANCE_NEUTRAL = 0,
  ...
  NUM_EE_CONTROL_STALK_ANALOG_STATES,
} EEControlStalkAnalogState;

typedef enum {
  EE_CONTROL_STALK_DIGITAL_CC_SET_RELEASED = 0,
  ...
  NUM_EE_CONTROL_STALK_DIGITAL_STATES,
} EEControlStalkDigitalState;
