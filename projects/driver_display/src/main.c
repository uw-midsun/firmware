...
int main(void) {
  ...
  GPIOAddress screen_data[] = { [DRIVER_DISPLAY_BRIGHTNESS_SCREEN1] = { GPIO_PORT_A, 7 },
                                [DRIVER_DISPLAY_BRIGHTNESS_SCREEN2] = { GPIO_PORT_A, 4 } };

  DriverDisplayBrightnessSettings settings = { .screen_address = screen_data,
                                               .adc_address = { .port = GPIO_PORT_A, .pin = 0 },
                                               .timer = PWM_TIMER_14,
                                               .frequency_hz = 30000,
                                               .update_period_s = 5 };

  DriverDisplayBrightnessCalibrationData calibration_data = { .max = 4095, .min = 0 };
