...
#define CC_CFG_CAN_DEVICE_ID SYSTEM_CAN_DEVICE_DRIVER_CONTROLS_CENTER_CONSOLE
...
#define CC_CFG_I2C_BUS_PORT I2C_PORT_2
#define CC_CFG_I2C_BUS_SDA \
  { GPIO_PORT_B, 11 }
#define CC_CFG_I2C_BUS_SCL \
  { GPIO_PORT_B, 10 }
