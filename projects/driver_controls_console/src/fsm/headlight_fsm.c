...
FSM_STATE_TRANSITION(headlight_off) {
  ...
  FSM_ADD_TRANSITION(INPUT_EVENT_CENTER_CONSOLE_CONTROL_STALK_DIGITAL_HEADLIGHT_FWD_PRESSED, headlight_highbeam);
}

FSM_STATE_TRANSITION(headlight_lowbeam) {
  FSM_ADD_TRANSITION(INPUT_EVENT_CENTER_CONSOLE_LOWBEAMS, headlight_off);
  FSM_ADD_TRANSITION(INPUT_EVENT_CENTER_CONSOLE_DRL, headlight_drl);
  FSM_ADD_TRANSITION(INPUT_EVENT_CENTER_CONSOLE_CONTROL_STALK_DIGITAL_HEADLIGHT_FWD_PRESSED,
                     headlight_lowbeam_highbeam);

  FSM_ADD_TRANSITION(INPUT_EVENT_CENTER_CONSOLE_POWER_STATE_OFF, headlight_off);
  FSM_ADD_TRANSITION(INPUT_EVENT_CENTER_CONSOLE_POWER_STATE_FAULT, headlight_off);
}
...
FSM_STATE_TRANSITION(headlight_lowbeam_highbeam) {
  ...
  FSM_ADD_TRANSITION(INPUT_EVENT_CENTER_CONSOLE_CONTROL_STALK_DIGITAL_HEADLIGHT_FWD_RELEASED, headlight_lowbeam);
...
FSM_STATE_TRANSITION(headlight_drl_highbeam) {
  ...
  FSM_ADD_TRANSITION(INPUT_EVENT_CENTER_CONSOLE_CONTROL_STALK_DIGITAL_HEADLIGHT_FWD_RELEASED, headlight_drl);
...
FSM_STATE_TRANSITION(headlight_highbeam) {
  FSM_ADD_TRANSITION(INPUT_EVENT_CENTER_CONSOLE_LOWBEAMS, headlight_lowbeam_highbeam);
  FSM_ADD_TRANSITION(INPUT_EVENT_CENTER_CONSOLE_DRL, headlight_drl_highbeam);
  FSM_ADD_TRANSITION(INPUT_EVENT_CENTER_CONSOLE_CONTROL_STALK_DIGITAL_HEADLIGHT_FWD_RELEASED, headlight_off);
