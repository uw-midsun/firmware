...
FSM_STATE_TRANSITION(headlight_off) {
  ...
  FSM_ADD_TRANSITION(INPUT_EVENT_CENTER_CONSOLE_CONTROL_STALK_DIGITAL_HIGH_BEAM_FWD_PRESSED,
                     headlight_highbeam);
}
...
FSM_STATE_TRANSITION(headlight_lowbeam_highbeam) {
  ...
  FSM_ADD_TRANSITION(INPUT_EVENT_CENTER_CONSOLE_CONTROL_STALK_DIGITAL_HIGH_BEAM_FWD_RELEASED,
                     headlight_lowbeam);
