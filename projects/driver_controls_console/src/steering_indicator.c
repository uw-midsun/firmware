...
static const EventId s_steering_output_mapping[NUM_EE_CONTROL_STALK_EVENTS] = {
  ...
  [EE_CONTROL_STALK_ANALOG_CC_TURN_SIGNAL_RIGHT] = INPUT_EVENT_CONTROL_STALK_ANALOG_TURN_SIGNAL_RIGHT,
  ...
  [EE_CONTROL_STALK_DIGITAL_HORN_PRESSED] =
      INPUT_EVENT_CONTROL_STALK_DIGITAL_HORN_PRESSED,
  [EE_CONTROL_STALK_DIGITAL_HORN_RELEASED] =
