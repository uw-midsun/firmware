...
PLUTUS_CFG_INPUT_BITSET_SPLIT, PLUTUS_CFG_INPUT_BITSET_FULL, PLUTUS_CFG_INPUT_BITSET_SPLIT
}
#endif

#define PLUTUS_CFG_SPI_PORT SPI_PORT_1
#define PLUTUS_CFG_SPI_BAUDRATE 750000
#define PLUTUS_CFG_SPI_MOSI \
  { .port = GPIO_PORT_A, .pin = 7 }
#define PLUTUS_CFG_SPI_MISO \
  { .port = GPIO_PORT_A, .pin = 6 }
#define PLUTUS_CFG_SPI_SCLK \
  { .port = GPIO_PORT_A, .pin = 5 }
#define PLUTUS_CFG_SPI_CS \
