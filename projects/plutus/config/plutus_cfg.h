...
#define PLUTUS_CFG_HEARTBEAT_EXPECTED_DEVICES CAN_ACK_EXPECTED_DEVICES(SYSTEM_CAN_DEVICE_CHAOS, SYSTEM_CAN_DEVICE_DRIVER_CONTROLS)

// HV Relay - power/ground
#define PLUTUS_CFG_RELAY_DELAY_MS 1000
#define PLUTUS_CFG_RELAY_PWR { .port = GPIO_PORT_B, .pin = 5 }
#define PLUTUS_CFG_RELAY_GND { .port = GPIO_PORT_B, .pin = 4 }

// Fans
#define PLUTUS_CFG_FAN_1 { .port = GPIO_PORT_A, .pin = 10 }
#define PLUTUS_CFG_FAN_2 { .port = GPIO_PORT_A, .pin = 9 }
