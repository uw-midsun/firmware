...
typedef enum {
  ...
  // Headlight state events
  INPUT_EVENT_HEADLIGHT_STATE_OFF,
  INPUT_EVENT_HEADLIGHT_STATE_DRL,
  INPUT_EVENT_HEADLIGHT_STATE_LOWBEAM,
  INPUT_EVENT_HEADLIGHT_STATE_HIGHBEAM,

  // Hazards state events
  INPUT_EVENT_HAZARDS_STATE_OFF,
  INPUT_EVENT_HAZARDS_STATE_ON,
