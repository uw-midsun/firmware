...
// this function guides the user of the module through the calibration process to retreive the min/max allowed values 
StatusCode magnetic_brake_event_generator_init(MagneticCalibrationData *data, MagneticBrakeSettings *brake_settings, Ads1015Channel channel);
