...
typedef int16_t ThrottleZoneThresh[NUM_THROTTLE_ZONES][NUM_THROTTLE_THRESHES];
...
typedef struct ThrottleCalibrationData {
  ThrottleZoneThresh zone_thresholds_main;
  ThrottleZoneThresh zone_thresholds_secondary;
