...
// pressed and released, then correlates that data to a position value and generates a linear equation
// between the LSB input and position.
...
typedef struct MechBrakeSettings {
  ...
  int16_t bounds_tolerance; // a tolerance between 0 - 100 for the lower and upper bound of the position.
