...
int main() {
  ...
  ads1015_configure_channel(&data, ADS1015_CHANNEL_1, true, NULL, &data);
  ads1015_configure_channel(&data, ADS1015_CHANNEL_2, true, NULL, &data);
  ads1015_configure_channel(&data, ADS1015_CHANNEL_0, false, NULL, &data);
  ads1015_configure_channel(&data, ADS1015_CHANNEL_1, false, NULL, &data);
