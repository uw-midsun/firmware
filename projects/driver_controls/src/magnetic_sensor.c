...
StatusCode magnetic_sensor_init(I2CPort i2c_port) {
  ...
  status_ok_or_return(i2c_read(i2c_port, TLV493D_ADDRESS, s_read_reg, NUM_TLV493D_READ_REGISTERS));
  ...
  s_write_reg[TLV493D_WRITE_MOD1] =
      (s_read_reg[TLV493D_READ_FACTSET1] & TLV493D_FACTSET1_MASK) | TLV493D_MASTER_CONTROLLED_MODE;
