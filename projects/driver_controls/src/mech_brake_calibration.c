...
StatusCode mech_brake_calibration_init(MechBrakeCalibrationStorage *storage, MechBrakeSettings *settings){
...
StatusCode mech_brake_sample(MechBrakeCalibrationStorage *storage, MechBrakeCalibrationPoint point) {
  ...
  // Disables channel
  ads1015_configure_channel(storage->settings.ads1015, storage->settings.channel, false, NULL, NULL);
  ...
  // enables channel
  ads1015_configure_channel(storage->settings.ads1015, storage->settings.channel, true, prv_callback_channel, storage);
...
StatusCode mech_brake_calibration_result(MechBrakeCalibrationStorage* storage, MechBrakeCalibrationData *calib_data){
