...
typedef struct {
  ...
  // TODO: Once the hardware bug gets fixed, then remove this special case
  ...
  //
  // TODO: Once the hardware bug gets fixed, then remove this variable, as this
  // should be handled by the GPIO IT.
...
// ports.
//
// TODO: Once the HW fix is in, this should be removed, as this should be
// handled by the GPIO IT.
