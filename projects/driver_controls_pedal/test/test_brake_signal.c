...
void test_brake_signal_on_when_power_state_drive_and_direction_forward_and_throttle_in_brake_region_and_speed_over_threshold(
    void) {
  // Enter Drive State
  TEST_ASSERT_TRUE(TEST_BRAKE_SIGNAL_CLOCK_EVENT(PEDAL_EVENT_INPUT_POWER_STATE_DRIVE, 0));
...
void test_brake_signal_on_when_power_state_drive_and_direction_reverse_and_throttle_in_brake_region_and_speed_over_threshold(
    void) {
  // Enter Drive State
  TEST_ASSERT_TRUE(TEST_BRAKE_SIGNAL_CLOCK_EVENT(PEDAL_EVENT_INPUT_POWER_STATE_DRIVE, 0));
