...
FSM_STATE_TRANSITION(state_no_signal) {
  FSM_ADD_TRANSITION(PEDAL_EVENT_INPUT_CONTROL_STALK_ANALOG_TURN_SIGNAL_LEFT, state_left_signal);
  FSM_ADD_TRANSITION(PEDAL_EVENT_INPUT_CONTROL_STALK_ANALOG_TURN_SIGNAL_RIGHT, state_right_signal);
}

FSM_STATE_TRANSITION(state_left_signal) {
  FSM_ADD_TRANSITION(PEDAL_EVENT_INPUT_POWER_STATE_OFF, state_no_signal);
  FSM_ADD_TRANSITION(PEDAL_EVENT_INPUT_POWER_STATE_FAULT, state_no_signal);

  FSM_ADD_TRANSITION(PEDAL_EVENT_INPUT_CONTROL_STALK_ANALOG_TURN_SIGNAL_NONE, state_no_signal);
  FSM_ADD_TRANSITION(PEDAL_EVENT_INPUT_CONTROL_STALK_ANALOG_TURN_SIGNAL_RIGHT, state_right_signal);
}
