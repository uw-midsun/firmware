...
FSM_STATE_TRANSITION(state_horn_off) {
  FSM_ADD_TRANSITION(PEDAL_EVENT_INPUT_CONTROL_STALK_DIGITAL_HORN_PRESSED, state_horn_on);
}

FSM_STATE_TRANSITION(state_horn_on) {
  FSM_ADD_TRANSITION(PEDAL_EVENT_INPUT_CONTROL_STALK_DIGITAL_HORN_RELEASED, state_horn_off);

  FSM_ADD_TRANSITION(PEDAL_EVENT_INPUT_POWER_STATE_OFF, state_horn_off);
  FSM_ADD_TRANSITION(PEDAL_EVENT_INPUT_POWER_STATE_FAULT, state_horn_off);
}
