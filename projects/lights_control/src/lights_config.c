...
static uint16_t s_front_event_mappings[][2] = {
  { LIGHTS_EVENT_HORN,                                                           //
    LIGHTS_CONFIG_TO_MASK(LIGHTS_CONFIG_FRONT_LIGHT_HORN) },                     //
  ...
  { LIGHTS_EVENT_DRL,                                                            //
    LIGHTS_CONFIG_TO_MASK(LIGHTS_CONFIG_FRONT_LIGHT_DRL_RIGHT) |                 //
...
static uint16_t s_rear_event_mappings[][2] = {
  { LIGHTS_EVENT_STROBE_BLINK,                                               //
    LIGHTS_CONFIG_TO_MASK(LIGHTS_CONFIG_REAR_LIGHT_STROBE) },                //
  { LIGHTS_EVENT_BRAKES,                                                     //
    LIGHTS_CONFIG_TO_MASK(LIGHTS_CONFIG_REAR_LIGHT_RIGHT_BRAKE) |            //
