...
// Sets the state of the pins provided. Must be initialized first or unexpected
// behavior may ensue.
StatusCode gpio_seq_set_state(const GPIOAddress *addrs, size_t num_addrs,
                              GPIOState state, uint32_t delay_time_us);
