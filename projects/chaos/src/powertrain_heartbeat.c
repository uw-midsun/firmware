...
static void prv_send_hb_request(SoftTimerId timer_id, void *context) {
  ...
  CanAckRequest ack_req = {
    ...
    .expected_bitset = CAN_ACK_EXPECTED_DEVICES(
        SYSTEM_CAN_DEVICE_PLUTUS, SYSTEM_CAN_DEVICE_PLUTUS_SLAVE, SYSTEM_CAN_DEVICE_DRIVER_CONTROLS_CENTER_CONSOLE,
        SYSTEM_CAN_DEVICE_DRIVER_CONTROLS_PEDAL, SYSTEM_CAN_DEVICE_DRIVER_CONTROLS_STEERING,
