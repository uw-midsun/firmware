...
void slave_register_callback(SlaveMessages slave_response_id,
                             slave_callback callback, void *context);

// An application of *slave_callback
static int prv_process_message(SlaveMessages slave_response_id, uint8_t *data,
                               size_t data_length, void *context);
